...
namespace KeePassShtokal.Infrastructure.Migrations
{
    ...
    [Migration("20210121235450_EntryHistory")]
    partial class EntryHistory
    {
            ...
            modelBuilder.Entity("KeePassShtokal.Infrastructure.Entities.EntryAction", b =>
                {
                    b.HasOne("KeePassShtokal.Infrastructure.Entities.Entry", "Entry")
                        .WithOne()
                        .HasForeignKey("KeePassShtokal.Infrastructure.Entities.EntryAction", "EntryId")
                        .IsRequired();

                    b.HasOne("KeePassShtokal.Infrastructure.Entities.EntryState", "EntryState")
                        .WithOne()
                        .HasForeignKey("KeePassShtokal.Infrastructure.Entities.EntryAction", "EntryStateId")
                        .IsRequired();

                    b.HasOne("KeePassShtokal.Infrastructure.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("KeePassShtokal.Infrastructure.Entities.EntryAction", "UserId")
                        .IsRequired();
